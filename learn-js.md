...
huge following, there are a number of courses available, vast communities and
...
truth, I don't know there is a coder alive (or otherwise) that could claim to
...
start to learn at whatever speed they feel comfortable with. Likewise, a
...
but this tool can turn the mystical into manipulatable.
...
- Next, we log the *value* of the variable we defined. This is done by passing
  the variable name in to the `console.log()` with no quotes. > An example
- Finally, we have a mix and match of two things. The string as written between
  ...
  very useful JS feature. > The number = 139

This becomes more useful as you start to manipulate variables, retrieve DOM
...
This is a reference to the actual HTML element. If you hover of the logged
element, you should find the element is highlighted in the document. If you
right click the log you can 'Reveal in Elements Panel' and this will take you to
the exact element in the HTML structure. If you aren't sure you are targeting
the correct element, this is a great tool to use. It doesn't have to be done
from DevTools either, it can be included in your JavaScript file at a point of
your choosing.
...
then multiply by 5. Then multiply that result by 50 and finally subtract 10 and
...
like the Python Tutor) and can be done alongside your own HTML document:
...
the start and end points. Use this to your advantage and you will find a step by
step approach rapidly increases your knowledge of JavaScript. If you are not
sure...log it!
...
Just remember, a lot of highly skilled programmers may have answered questions
...
doing at each stage and really focus on gaining comprehension of the language -
you will soon find yourself a `Foo Bar` virtuoso. The more you practice, the
more you break and re-make, the more you experiment and explore the results, the
more affluent you will become in this dark art.
